...
using static LaxmiSunriseBank.Models.LaxmiSunriseBank.SendTransactionResponseXMLModel;

namespace LaxmiSunriseBank.Models.LaxmiSunriseBank
{

    public class SendTransactionResponseModel
    {
    ...
    public class SendTransactionResponseXMLModel
    {
        ...
        public class Body
        {
            [XmlElement("SendTransactionResponse", Namespace = "ClientWebService")]
            public SendTransactionResponse SendTransactionResponse { get; set; }
        }

        public class SendTransactionResponse
        {
            [XmlElement(ElementName = "SendTransactionResult")]
            public TransactionDetails TransactionDetails { get; set; }
        }
        ...
        public class TransactionDetails
        {
            ...
            public string SettlementDollarRate { get; set; }
        }
    }
}
